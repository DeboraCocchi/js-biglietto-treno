...
<svg class="mx-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-train-front-fill" viewBox="0 0 16 16">
...
</svg> Il prezzo totale del tuo biglietto è:<strong> ${roundedPrice} €</strong> 
`;
